...
def test_scrape_source_dispatches_by_type(monkeypatch):
    ...
    assert refresh.scrape_source(get_source("plantgoodseed")) == ["shop"]
...
def test_build_catalog_doc_shape_and_json_roundtrip():
    doc = refresh.build_catalog_doc("plantgoodseed", [{"source_id": 1}], "2026-06-19 00:00:00 UTC")
    assert doc == {"source": "plantgoodseed", "fetched_utc": "2026-06-19 00:00:00 UTC",
                   "records": [{"source_id": 1}]}
