...
USER_AGENT = (
    ...
    "(+https://sandiegoseedcompany.com; public Store API; contact husenathan@gmail.com)"
)
...
# --------------------------------------------------------------------------- #
# HTML -> clean plain text / light markdown
# --------------------------------------------------------------------------- #
...
def html_to_text(raw: str | None) -> str:
    ...
    for ln in lines:
        if ln:
            ...
            out.append("")
            blank = True
    # Fix bullets that may have a stray blank after the marker.
    return "\n".join(out).strip()
